...
namespace Tyvj.Controllers
{
    public class ReplyController : BaseController
    {
        ...
        public ActionResult Delete(int id)
        {
            ...
            if (reply.UserID == ViewBag.CurrentUser.ID || (reply.FatherID != null && reply.Father.UserID == ViewBag.CurrentUser.ID) || ((DataModels.User)ViewBag.CurrentUser).Role >= UserRole.Master)
            {
