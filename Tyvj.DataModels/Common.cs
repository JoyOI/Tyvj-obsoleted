...
namespace Tyvj.DataModels
{
    ...
    {
        public static string[] LanguageDisplay = { "C", "C++", "C++11", "Java", "Pascal", "Python 2.7", "Python 3.3", "Ruby", "C#", "VB.Net", "F#", "C++14" };
    ...
    public enum Language { C, Cxx, Cxx11, Java, Pascal, Python27, Python33, Ruby, CSharp, VB, FSharp, Cxx14 };
